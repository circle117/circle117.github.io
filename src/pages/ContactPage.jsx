...
export default function ContactPage() {
  return (
    <div
      id="contact"
      className="flex relative py-[6vh] h-[90vh] justify-center items-center"
    >
      <div>
        ...
        <div className="flex border-2 p-4 px-8 gap-4 rounded-full border-primary justify-center text-center">
